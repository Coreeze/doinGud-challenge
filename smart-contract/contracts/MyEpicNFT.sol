...
contract EpicNFTContract is ERC721URIStorage {
  ...
  string[] firstWords = ["Nature", "Ocean", "Animal"];
  string[] secondWords = ["Air", "Fire", "Earth"];
  string[] thirdWords = ["Pokemon", "Pizza", "Ironman"];

  string[] colors = ["red", "#08C2A8", "black", "yellow", "blue", "green"];

  event NewEpicNFTMinted(address sender, uint256 tokenId);

  constructor() ERC721("SocialNFT", "SOCIAL") {
